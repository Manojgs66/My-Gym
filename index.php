	...
	<div class="wrapper">
		...
		<div class="content_wrapper">
			<div class="right" style="background-image: url(images/right.jpg)">
					...
					<a href="index.php?add_users">Add Users</a>
		...
		<!-- footer Start -->
		<div class="footer">
			<h5 style="color:#000; padding-top:30px; text-align:center; font-family: Verdana, Geneva, sans-serif">&copy; 2019 all rights reserved | Developed By Manoj GS and Narasimha : <a href="https://www.facebook.com/Manoj GS Manu">Manoj GS </a></h5>
		</div>
		<!-- Footer End -->
